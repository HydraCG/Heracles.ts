[@hydra-cg/heracles.ts](../README.md) > [LinksCollection](../classes/linkscollection.md)
...
⊕ **new LinksCollection**(links?: *`Iterable`<[ILink](../interfaces/ilink.md)>*): [LinksCollection](linkscollection.md)
